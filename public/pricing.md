  ...
  "plans": [
    {
      ...
      "features": ["56 map layers", "500+ feeds", "country briefs", "chokepoints", "instability scores", "watchlists", "3 dashboard tabs"]
    },
    {
      "name": "Pro",
    ...
    },
    {
      ...
      "features": ["Everything in Pro", "commercial license included", "data export — CSV, JSON and PDF reports", "25 custom dashboards", "MCP 250 calls/day", "priority support"]
    },
    {
      "name": "API",
    ...
    },
    {
      ...
      "features": ["Everything in API Starter", "redistribution rights", "300 requests/minute", "10,000 requests/day", "5 Pro licenses included", "same company email required", "commercial license for your customers", "priority support"]
    },
    {
      "name": "Enterprise",
      "price": "Custom",
